...
-- load trainning_size
matrix_words = csvigo.load{path='pre-processing/train_data/postag_full_train_matrix_file.txt', mode='large', separator=' '}
...
-- read labels
labelsRaw = csvigo.load{path='pre-processing/train_data/postag_full_train_label_file.txt', mode='large', separator=' '}
...
-- load test_data -- 
matrix_words_test = csvigo.load{path='pre-processing/train_data/postag_full_test_matrix_file.txt', mode='large', separator=' '}
...
-- read labels -- 
labelsRawTest = csvigo.load{path='pre-processing/train_data/postag_full_test_label_file.txt', mode='large', separator=' '}
